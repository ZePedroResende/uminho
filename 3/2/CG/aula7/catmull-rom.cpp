...
void getCatmullRomPoint(float t, float *p0, float *p1, float *p2, float *p3, float *pos, float *deriv) {
  ...
  multMatrixVector(m[1],y,a[1]);
  multMatrixVector(m[2],z,a[2]);

	// Compute pos = T * A
float T[4] = { (float)pow((double)t,3), (float)pow((double)t,2), t, 1};
pos[0] = {T[0] * a[0][0] + T[1] * a[1][0] + T[2] * a[2][0] + T[3] * a[3][0]};
pos[1] = {T[0] * a[0][1] + T[1] * a[1][1] + T[2] * a[2][1] + T[3] * a[3][1]};
pos[2] = {T[0] * a[0][2] + T[1] * a[1][2] + T[2] * a[2][2] + T[3] * a[3][2]};
